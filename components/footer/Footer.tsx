...
/**
 * Footer Component for AsyncAPI website
 *
 */
export default function Footer() {
  return (
    <footer className='margin: 0 auto mt-12 bg-dark'>
      <div className='mx-auto max-w-screen-xl divide-y divide-cool-gray overflow-hidden px-3 py-4 sm:p-6 md:py-12
      lg:px-8 xl:py-16'>
        ...
        <div className='justify-between py-8 sm:flex sm:py-12 xl:mt-20' data-testid='Footer-content'>
          <div className='w-full sm:w-2/3'>
            ...
            <p className='w-full text-left text-sm leading-6 text-cool-gray sm:w-2/3' data-testid='Footer-copyright'>
              ...
              For web site terms of use, trademark policy and general project policies please see <a href='https://lfprojects.org' className='text-secondary-500 underline transition duration-300 ease-in-out hover:text-white' target='_blank' rel='noopener noreferrer'>https://lfprojects.org</a>
            </p>
          </div>
